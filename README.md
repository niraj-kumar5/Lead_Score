...
## Details of files given
    ...
    + Lead Score Case Study Niraj Kumar & Mahiboob Ali.ipynb : The python file showing coding and data analysis
    + Assignment Subjective Questions.pdf : Some subjective questions answered
    + Lead Score Case Study presentation.pdf : Final Presentation
    + Summary_Report.pdf : Summary on what's done in the entire py file
